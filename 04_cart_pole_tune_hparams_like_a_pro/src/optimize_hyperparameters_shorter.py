...
def objective(
    ...
    train(
        ...
        n_episodes_evaluate_agent=1000,
        freq_episodes_evaluate_agent=100,
    )
...
if __name__ == '__main__':
    ...
    # set Optuna study
    study = optuna.create_study(study_name='hyperparameters_deep_q_agent',
                                direction='maximize')
